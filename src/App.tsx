                  ...
                  <motion.div whileHover={{ y: -5 }} className="md:col-span-3 bg-zinc-900/40 border border-white/5 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-sm overflow-hidden relative">
                    ...
                    <div className="w-full md:w-1/2 h-48 bg-zinc-800/50 rounded-xl border border-white/10 relative overflow-hidden">
                       <div className="absolute inset-0 flex items-center justify-center gap-4 p-4">
                          <div className="w-1/3 h-full bg-zinc-700/50 rounded-lg animate-pulse" />
                          <div className="w-1/3 h-full bg-[#a60724]/10 rounded-lg border border-[#a60724]/20 flex items-center justify-center">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3 text-sm text-zinc-400">
                          <Clock className="w-4 h-4 text-[#a60724]" />
                          <span>Responding within 5 minutes makes you 21x more likely to convert</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-zinc-400">
                          <Bell className="w-4 h-4 text-[#a60724]" />
                          <span>Automated follow-ups ensure your leads won't go cold</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-zinc-400">
                          <Zap className="w-4 h-4 text-[#a60724]" />
                          <span>Focus on your business while we bridge the gap to your next client</span>
                        </div>
                      </div>
                    </div>
